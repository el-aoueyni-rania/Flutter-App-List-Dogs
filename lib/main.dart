...
class MyApp extends StatelessWidget {
  ...
  child : Image.asset("images/${dog.image}", width: 100, height: 100, fit: BoxFit.cover),
  ),
  Expanded(
  child: Container(
  ...
  child: Column(
  children: [
  Image.asset("images/${dog.image}", width: double.infinity, height: 250, fit: BoxFit.cover),
  Padding(
